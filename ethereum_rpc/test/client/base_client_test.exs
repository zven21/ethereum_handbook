defmodule EthereumRPC.Client.BaseClientTest do
  @moduledoc false
  ...
  defmodule ClientMock do
    use EthereumRPC.Client.BaseClient

    def post_request(payload, opts) do
      case Jason.decode!(payload) do
        %{"method" => method, "jsonrpc" => "2.0", "params" => params} = jason_payload ->
          Logger.info("Method #{method} params is #{payload}")
  ...
  test ".eth_new_pending_transaction_filter/0", do: Helpers.check("eth_new_pending_transaction_filter")
